...
let appKit /*:ReturnType<typeof createAppKit> | undefined */ = $state(undefined);
...
const initialize = (networks /*: AppKitNetwork[]*/, metadata /* Metadata | undefined*/) => {
	...
	networks = networks ? networks : [mainnet];
	...
	if (browser) {
		if (!PROJECT_ID) throw new Error("reown project id not set");
